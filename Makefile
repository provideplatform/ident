.PHONY: build build_sia_consumer clean ecs_deploy install integration lint migrate mod run_api run_consumer run_local run_local_dependencies stop_local_dependencies stop_local test
