...
func VendNatsBearerAuthorization(subject string, publishAllow, publishDeny, subscribeAllow, subscribeDeny []string, responsesMax, responsesTTL *int) (*Token, error) {
	token := &Token{
